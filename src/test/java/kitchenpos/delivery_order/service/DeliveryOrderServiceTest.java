package kitchenpos.delivery_order.service;
...
import kitchenpos.delivery_order.infra.FakeKitchenridersClient;
import kitchenpos.delivery_order.infra.InMemoryDeliveryOrderRepository;
import kitchenpos.menu.domain.MenuRepository;
import kitchenpos.menu.infra.InMemoryMenuRepository;
import kitchenpos.order.domain.OrderLineItem;
import kitchenpos.order.domain.OrderType;
import kitchenpos.delivery_order.application.KitchenridersClient;
...
class DeliveryOrderServiceTest {
    ...
    @Test
    void accept() {
        final UUID orderId = orderRepository.save(order(kitchenpos.delivery_order.domain.OrderStatus.WAITING, "어드레스!")).getId();
